...
| QR-04 | `Regression risk` | Real-time snapshots, confirmed-state reconciliation, OCC conflict handling, listener cleanup and controlled two-tab Production behaviour were approved through AB-EV-013. |
