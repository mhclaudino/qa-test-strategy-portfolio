...
| [AB-EV-016 — QR-24 Passed through detailed-visit workflow](./qr-24-passed-through-detailed-visit-workflow.md) | Approved physical-passage workflow, multiple detailed visits, explicit Save, private memories and canonical metrics | Static implementation audit, 18 focused tests, 139-test full regression, lint and production build | Passed — QR-24 moved to Regression risk |
