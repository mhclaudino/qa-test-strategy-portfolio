...
| [AB-EV-015 — QR-13 immediate username reuse](./qr-13-immediate-username-reuse-accepted-behaviour.md) | Immediate release after username change, no alias/redirect, containment audit and permanent accepted-behaviour regression | Local repository audit, focused tests, full suite, lint and production build | Passed — QR-13 remains Accepted behaviour |
| [AB-EV-016 — QR-24 Passed through detailed-visit workflow](./qr-24-passed-through-detailed-visit-workflow.md) | Approved physical-passage workflow, multiple detailed visits, explicit Save, private memories and canonical metrics | Static implementation audit, 18 focused tests, full regression, lint and production build | Passed — QR-24 moved to Regression risk |
...
| [AB-EV-020 — United Kingdom coverage and geographic counter integrity](./ab-ev-020-uk-coverage-and-geographic-counter-integrity.md) | 251-place, 195-country and 56 territory/entity model; UK constituent overlap and UK country/achievement rule | Local unit/regression validation and Vercel Production | Passed — QR-18, QR-25 and QR-29 retained as regression risks |
