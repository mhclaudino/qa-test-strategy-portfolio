...
| [AB-EV-014 — QR-11 username case-normalisation Production validation](./ab-ev-014-qr-11-username-case-normalisation-production-smoke.md) | Canonical lowercase identity, case-insensitive collision prevention, public lookup, generated links, data preservation and restoration | Vercel Production and local automated regression (2026-07-31) | Passed — approved by Test Lead; QR-11 moved to Regression risk |
