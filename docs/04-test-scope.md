...
- private/public place projection synchronisation;
- Clear Map cleanup;
...
AB-EV-033 Production validation recorded zero private reads by the viewer and no forbidden public place fields.
...
AB-EV-033 extends lifecycle expectations to Wishlist membership/ranks/public preference and public-profile places.
...
High-value checkpoints include static quality gates, unit/domain tests, Rules, persistence/privacy E2E, geographic/map regression, lifecycle scenarios and responsive/profile flows.
